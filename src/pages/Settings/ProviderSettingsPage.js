...
const ProvideSettingsPage = () => {
  ...
  const [activeTab, setActiveTab] = useState(tabs.personal.value);
  ...
  <div className={`flex items-center justify-between p-4 bg-[var(--bg-primary)] rounded-xl border border-[var(--primary-20)]`}>
    ...
    <div className="flex items-center gap-4">
      <span className={`px-2 py-1 text-[10px] font-bold rounded uppercase ${
        statusColor === "green" ? "bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400" : "bg-gray-200 dark:bg-gray-700 text-gray-500"
      }`}>{status}</span>
    ...
    <div className="p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 dark:text-gray-400 mt-2">
          Manage your professional identity, payment flows, and connectivity
          preferences.
        </p>
      </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          <div className="bg-surface-light dark:bg-surface-dark p-8 rounded-xl shadow-sm border border-[var(--primary-20)] text-center">
            ...
            <div className="relative inline-block mb-6">
              ...
              />
              <button className="absolute bottom-1 right-1 size-10 bg-primary text-[var(--bg-secondary)] bg-[var(--primary)] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform">
  ...
  <TabButton
    key={tab} // always add a key when rendering lists
    active={activeTab === tabs[tab].value}
    onClick={() => setActiveTab(tabs[tab].value)}
    icon={tabs[tab].icon} // use the correct icon from the tab
                ...
                <div className="space-y-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        disabled={true}
                        placeholder="Abdel Qayyim"
                        id="first_name"
                        className="w-full h-[40px] border rounded bg-[var(--bg-primary)] border border-[var(--primary-20)] px-2 outline-none"
                      />
                    </div>
                  ...
                  <div className="pt-6 border-t border-[var(--primary-20)] ">
                    <h4 className="text-base font-bold mb-4 text-[var(--text-primary)]">
                      Business Location
                    </h4>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="md:col-span-2 space-y-2">
                        ...
                        <input
                          ...
                          placeholder="23 Property Plaza, Suite 400 New York, NY 10001"
                          disabled={true}
                        />
                      </div>
                    </div>
  ...
  <div className="space-y-8">
    {/* Saved Cards Section */}
    <div className="mb-12">
      <div className="relative h-[280px] w-full max-w-[440px] mx-auto">
        ...
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-64 bg-accent-gold rounded-2xl -translate-y-4 scale-95 opacity-80 shadow-lg">
          <div className="p-8 text-white/50">
            <div className="size-10 bg-white/20 rounded-lg mb-4"></div>
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <button className="text-primary text-sm font-bold hover:underline flex items-center gap-1 text-[var(--primary)]">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        />
            ...
            {/* Footer */}
            <div className="px-8 py-6 bg-[var(--bg-primary)] dark:bg-slate-800/50 rounded-b-xl border-t border-[var(--primary-20)]  flex justify-end gap-4">
