...
export default function ProfileDropdown() {
  const avatar = (
    <div className="border-l-2 border-l-[var(--bg-primary)] relative group w-fit flex flex-row items-center p-[5px] cursor-pointer overflow-hidden">
      {/* Ripple Background */}
  ...
  return (
    <Dropdown
      ...
      containerClassName="w-fit rounded-md"
