...
const ViewCusomterHistory = ({ data }) => {
  ...
  return (
    <PopUpFormSkeleton
      formTitle="Service"
      onClose={() => dispatch(setSelectedUserHistory(undefined))}
    >
      <div className="flex flex-col gap-4">
        ...
        <div className="grid grid-cols-2 gap-10">
          ...
          <div className="flex flex-col gap-6 w-fit">
            ...
            {fillSection(
              <div className="text-purple-500">{REPAIR_SVG}</div>,
              "Service",
              data?.service,
              false,
              true
            ...
            {fillSection(
              <div className="text-orange-500">{CALENDAR_SVG}</div>,
              "Date",
              data?.price ? format(new Date(data.date), "MMM d, yyyy") : "N/A",
              false,
              true
            )}
          ...
          <div className="flex flex-col gap-6">
            ...
            {fillSection(
              <div className="text-emerald-500">{DOLLAR_SIGN_SVG}</div>,
              "Price",
              data?.price,
              false,
              true
        ...
        {fillSection(
          null,
          "Description",
          "Complete redesign and development of company website with modern UI/UX, responsive design, and SEO optimization."
        )}
        ...
        {fillSection(
          null,
          "Comment",
          "Excellent work! The website exceeded our expectations."
        )}
      </div>
    </PopUpFormSkeleton>
  );
